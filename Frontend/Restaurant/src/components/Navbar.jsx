...
const Navbar = () => {
  // defining a state toggle function for the mobile menu
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  // creating a toggle function for the mobile menu
  ...
  return (
    <nav className="fixed top-4 z-50 flex w-full flex-col items-center justify-center">
      <div className="flex w-full items-center justify-between overflow-y-hidden p-4 backdrop-blur-lg lg:m-2 lg:w-[50rem] lg:rounded-full lg:shadow-lg ">
        ...
        {/* lets add a div to display all the links */}
        ...
        {/* adding a div for toggle button */}
